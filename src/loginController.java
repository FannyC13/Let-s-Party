...
public class loginController {
    ...
    void SignInOnClick(ActionEvent event) {
        ...
        try {  
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/users", "Julian", "password");
            ...
            if( !Email.getText().isEmpty() && !password.getText().isEmpty() && !txtName.getText().isEmpty()){
                ...
                String queryString = "Select email, Password from Users where email='" + user + "' AND Password = '" + pass + "'";                    
            ...
            else JOptionPane.showMessageDialog(null, "Please enter an Email, a password and a name");
        ...
        void onClick(ActionEvent event) {
            ...
            try {  
                ...
                if( !Email.getText().isEmpty() && !password.getText().isEmpty()){
                    ...
                    String queryString = "Select email, Password, name from Users where email='" + user + "' AND Password = '" + pass + "'";                    
                ...
                else JOptionPane.showMessageDialog(null, "Please enter an Email and a password");
