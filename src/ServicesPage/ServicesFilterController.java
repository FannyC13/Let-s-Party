...
public class ServicesFilterController implements Initializable {
    ...
    public static String queryString = "WHERE Type like 'Person%'";

    @FXML
    void FilterButton(MouseEvent event) throws IOException {
        queryString = "WHERE Type like 'Person%'";
